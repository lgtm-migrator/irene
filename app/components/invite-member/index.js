/* eslint-disable ember/no-classic-components, ember/no-mixins, ember/no-classic-classes, ember/require-tagless-components, prettier/prettier, ember/no-get */
...
export default Component.extend(PaginateMixin, {
  ...
  closeModal: task(function* () {
    yield this.set('showInviteMemberModal', false);
  }),
  ...
  inviteMember: task(function* (email) {
    ...
    if (t) {
      ...
      const orgInvite = yield this.get('store').createRecord(
